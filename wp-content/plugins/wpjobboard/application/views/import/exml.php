...
<h1>
    ...
    <div class="wpjb-export-all">
        ...
        <table class="widefat post fixed" style="width:400px">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    <td>Jobs</td>
                    <td><?php echo $count["job"] ?></td>
                </tr>
                <tr>
                    <td>Applications</td>
                    <td><?php echo $count["application"] ?></td>
                </tr>
                <tr>
                    <td>Companies</td>
                ...
                <tr>
                    <td>Candidates</td>
                    <td><?php echo $count["resume"] ?></td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    <td>TOTAL</td>
                    <th><strong><?php echo array_sum($count) ?></strong></th>
                </tr>
            </tfoot>
        </table>

        <p>
            <a href="#" class="wpjb-export-all-run button-primary"><?php _e("Start Export", "wpjobboard") ?></a>
        </p>
        ...
        $.ajax({
            ...
            success: function(response) {
                if(response.todo > 0) {
                    ...
                    $(".wpjb-export-progress").hide();
                    $(".wpjb-export-all .spinner").css("visibility", "hidden");
