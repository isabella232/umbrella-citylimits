    ...
    <form action="" method="post" id="wpjb-resume" class="wpjb-form" enctype="multipart/form-data">
        ...
        <?php if($group->getName() == "experience"): ?>
            ...
            <fieldset class="wpjb-resume-detail wpjb-fieldset-<?php echo $group->getName() ?>">
                <legend>
                    ...
                    &nbsp;
                    <a href="<?php esc_attr_e(wpjr_link_to("myresume_detail_add", null, array("slug"=>$group->getName()))) ?>">(<?php _e("Add Experience", "wpjobboard") ?>)</a>
                </legend>
                ...
                <div>
                    <b>
                        ...
                        <a href="<?php echo wpjb_api_url("action/detail", array("id"=>$detail->id, "redirect_to"=>wpjr_link_to("myresume"))) ?>" class="button"><?php _e("Delete", "wpjobboard") ?></a>
                    </b>
        ...
        <?php elseif($group->getName() == "education"): ?>
            ...
            <fieldset class="wpjb-resume-detail wpjb-fieldset-<?php echo $group->getName() ?>">
                <legend>
                    <?php esc_html_e($group->title) ?>
                    &nbsp;
                    <a href="<?php esc_attr_e(wpjr_link_to("myresume_detail_add", null, array("slug"=>$group->getName()))) ?>">(<?php _e("Add Education", "wpjobboard") ?>)</a>
                </legend>
        ...
        <fieldset class="wpjb-fieldset-<?php esc_attr_e($group->getName()) ?>">
            <legend>
                <?php esc_html_e($group->title) ?>
                &nbsp;
                <a href="<?php esc_attr_e(wpjr_link_to("myresume_edit", null, array("slug"=>$group->getName()))) ?>">(<?php _e("Edit", "wpjobboard") ?>)</a>
            </legend>
