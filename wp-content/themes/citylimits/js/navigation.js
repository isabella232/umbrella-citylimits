(function() {
    ...
    Navigation.prototype.init = function() {
      ...
      this.mainEl = $('.sticky-nav-wrapper');
    ...
    Navigation.prototype.stickyNavScrollCallback = function(event) {
      ...
      // if we're around the header area and the top offset of the window is less than the top offset of the nav container,
      // remove the 'position-fixed' class and don't continue 
      ...
      if ( $(window).scrollTop() > this.mainEl.offset().top ) {
          $('.sticky-nav-holder').addClass('position-fixed');
      ...
      // if the top of the window offset is less than the fixed nav element top offset, remove 'position-fixed' class
      if ( $(window).scrollTop() < this.mainEl.offset().top ) {

        if( $('.sticky-nav-holder').hasClass('position-fixed') ) {
            $('.sticky-nav-holder').removeClass('position-fixed');
        }
