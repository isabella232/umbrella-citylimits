<?php
/**
 * City Limits Podcasts "Series Posts, Continued" widget, and associated function
 */
...
add_action( 'widgets_init', function() {
	register_widget( 'Citylimits_Series_Posts_Widget' );
});
/**
 ...
 *
 */
class Citylimits_Series_Posts_Widget extends WP_Widget {
