                ...
                <table>
                    <tbody>
                        <tr class="field-file-size">
                            <td><?php _e("Max. file zie<small>Maximum upload file size (in bytes)</small>", "wpjobboard") ?></td>
                            <td><input type="text" name="file_size" /></td>
                        </tr>
                        <tr class="field-file-ext">
                            <td><?php _e("Allowed formats<small>Comma seperated allowed file extensions</small>", "wpjobboard") ?></td>
