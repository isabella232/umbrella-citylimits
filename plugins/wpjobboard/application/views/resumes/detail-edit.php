...
<h1>
    ...
    &raquo; <a href="<?php esc_attr_e(wpjb_admin_url("resumes", "edit", $resume->id)) ?>"><?php echo ($user->first_name || $user->last_name) ? esc_html(trim($user->first_name." ".$user->last_name)) : esc_html("ID: ".$form->getId()) ?></a>
</h1>
