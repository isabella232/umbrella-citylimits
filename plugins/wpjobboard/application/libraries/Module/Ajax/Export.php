...
class Wpjb_Module_Ajax_Export {
    ...
    public function allAction()
    {
        ...
        set_transient($transient, $mapping, 3600);
    ...
    public static function companiesAction()
    {
        ...
        $param["filter"] = $request->get("filter", "all");
        $param["page"] = 1;
        $param["count"] = null;
        $param["posted"] = null;
        $param["ids_only"] = true;
    ...
    public static function csvAction()
    {
        ...
        foreach($map["ids"] as $id) {
            ...
            $model = $map["model"];
            $object = new $model($id);
            $csv = apply_filters("wpjb_export_csv_row", $object->csv($transient["fields"]), $model);
