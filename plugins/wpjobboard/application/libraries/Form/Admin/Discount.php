...
class Wpjb_Form_Admin_Discount extends Daq_Form_ObjectAbstract
{
    ...
    public function init()
    {
        ...
        $e->setHint(__("Specyfing Discount Value is not enough, you have to also select type of discount you can choose either fixed amount of money or percentage of total price.", "wpjobboard"));
